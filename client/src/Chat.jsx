        ...
        <div className="flex h-screen">
            <div className="bg-white w-1/3 flex flex-col">
                ...
                <div className="p-2 text-center flex items-center justify-center">
                    ...
                    <button onClick={logout} className="text-sm bg-blue-100 py-1 px-2 text-gray-500 border rounded-md">logout</button>
                </div>
                            ...
                            <div className="relative h-full">
                                <div className="overflow-y-scroll absolute top-0 left-0 right-0 bottom-2">
                                    {messageWithoutDupes.map(message => (
                                        // eslint-disable-next-line react/jsx-key
                                        <div key={message._id} className={(message.sender === id ? 'text-left' : 'text-right')}>
                                            <div className={"text-left inline-block p-2 my-2 rounded-lg text-sm " + (message.sender === id ? 'bg-blue-500 text-white' : 'bg-white text-grey-500')}>
                                                {message.text}
                                                {message.file && (
                                                    <div className="">
